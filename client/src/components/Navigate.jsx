    ...
    <>
      <div className='bg-dark text-muted' id='top-navbar'>
        <Container className='d-flex justify-content-between align-items-center'>
          <Link to='/location' className='d-flex align-items-center gap-2 text-muted'>Map tag <FontAwesomeIcon icon={faLocationDot} /></Link>
          <div>Contact: campingsite@gmail.com 07732817630</div>
        </Container>
      </div>
